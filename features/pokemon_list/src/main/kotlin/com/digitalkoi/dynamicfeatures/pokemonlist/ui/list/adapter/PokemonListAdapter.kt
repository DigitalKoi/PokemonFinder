package com.digitalkoi.dynamicfeatures.pokemonlist.ui.list.adapter
...
import com.digitalkoi.commons.ui.base.BaseListAdapter
import com.digitalkoi.commons.ui.base.BasePagedListAdapter
import com.digitalkoi.dynamicfeatures.pokemonlist.ui.list.PokemonListViewModel
import com.digitalkoi.dynamicfeatures.pokemonlist.ui.list.adapter.holders.PokemonViewHolder
import com.digitalkoi.dynamicfeatures.pokemonlist.ui.list.adapter.holders.ErrorViewHolder
import com.digitalkoi.dynamicfeatures.pokemonlist.ui.list.adapter.holders.LoadingViewHolder
...
class PokemonListAdapter @Inject constructor(
...
) : BasePagedListAdapter<PokemonItem>(
    ...
    override fun getItemId(position: Int) =
        when (getItemView(position)) {
            ItemView.POKEMON -> getItem(position)?.id ?: -1L
            ItemView.LOADING -> 0L
            ItemView.ERROR -> 1L
        }
